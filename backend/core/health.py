...
class HealthCalculator:
    def calculate_tdee(
        ...
        gender: str, 
        activity_level: str,
        # Parametri Livello 2 (Opzionali)
        body_fat_percent: Optional[float] = None,
        avg_daily_steps: Optional[int] = None
    ) -> dict:
        """
        Calcola il TDEE (Dispendio Energetico) usando una logica a cascata.
        """
        bmr = 0.0
        method = ""
        ...
        # SCENARIO PREMIUM: Katch-McArdle
        ...
        # SCENARIO STANDARD: Mifflin-St Jeor
        else:
            if gender.upper() == 'M':
